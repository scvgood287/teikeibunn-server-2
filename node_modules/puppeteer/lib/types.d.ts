...
/* Excluded from this release type: createTextContent */
...
export declare class HTTPResponse {
    ...
    declare class IntervalPoller<T> implements Poller_2<T> {
        #private;
    ...
    /* Excluded from this release type: isSuitableNodeForTextMatching */
    ...
    /* Excluded from this release type: Poller_2 */
    ...
    declare const PuppeteerUtil: Readonly<{
        ...
        createTextContent: (root: Node) => TextContent.TextContent;
        MutationPoller: typeof Poller.MutationPoller;
        RAFPoller: typeof Poller.RAFPoller;
        IntervalPoller: typeof Poller.IntervalPoller;
    ...
    declare class RAFPoller<T> implements Poller_2<T> {
        #private;
         ...
         * @returns {@link https://en.wikipedia.org/wiki/Unix_time | Unix timestamp}
         ...
         declare namespace TextContent {
             export {
                 ...
                 TextContent_2 as TextContent,
                 createTextContent
             }
         }

         /* Excluded from this release type: TextContent_2 */
